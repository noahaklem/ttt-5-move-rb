...
describe "./lib/move.rb" do
  ...
  context '#move' do
    it 'accepts 3 arguements: the board, position the player wants to fill and their char, X or O' do
    ...
    it 'allows X in the top left corner' do 
      board = [" ", " ", " ", " ", " ", " ", " ", " ", " "]
      move(board, 0, "X")
    ...
    it 'allows X in the bottom right' do
      board = [" ", " ", " ", " ", " ", " ", " ", " ", " "]
      move(board, 8, "X")
    ...
    it 'allows O in top left and X in top right' do
      board = [" ", " ", " ", " ", " ", " ", " ", " ", " "]
      move(board, 0, "O")
      move(board, 8, "X")
